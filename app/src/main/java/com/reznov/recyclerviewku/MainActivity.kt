...
class MainActivity : AppCompatActivity() {
    ...
    private fun showSelectedHero(hero: Hero){
        Toast.makeText(this, "Pick ${hero.name}",Toast.LENGTH_SHORT).show()
    }
    ...
    private fun showRecyclerList(){
        ...
        listHeroAdapter.setOnItemCilckCallback(object : ListHeroAdapter.OnItemClickCallback{
    ...
    private fun showRecyclerGrid() {
        ...
        gridHeroAdapter.setOnItemCilckCallback(object : GridHeroAdapter.OnItemClickCallback{
            override fun onItemClicked(data: Hero) {
                showSelectedHero(data)
            }
        })
